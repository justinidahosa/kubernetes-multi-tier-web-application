# Kubernetes Multi-Tier Web Application with Monitoring

This project demonstrates a production-style Kubernetes deployment of a multi-tier web application with full observability using Prometheus, Grafana, and Alertmanager. It includes a frontend, backend API, PostgreSQL database, ingress routing, autoscaling, metrics collection, dashboards, and alerting.

An architecture diagram is included to show how all components interact.

![Architecture Diagram](k8s-architecture.png)
...
Example alert:
- BackendDown fires when all backend pods are unavailable in the multi-tier-web-app namespace.
